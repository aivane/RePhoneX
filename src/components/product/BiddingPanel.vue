  ...
  <div class="bg-gray-900 rounded-3xl shadow-xl overflow-hidden p-6 text-white border border-gray-800 relative select-none">
    ...
    <div class="flex items-center justify-between mb-8">
      ...
      >
        ...
        {{ isEnded ? 'AUCTION CLOSED' : formattedTime }}
      </div>
    </div>
    ...
    <div class="mb-8 text-center transition-all duration-500">
      ...
      <!-- Winner / Leader UI -->
      <div v-if="isEnded" class="mt-4 px-4 py-3 bg-gray-800/80 rounded-xl border border-gray-700 inline-block shadow-inner mx-auto">
        <p class="text-sm text-gray-400">Winner</p>
        <p class="text-lg font-bold text-yellow-400 flex items-center justify-center">
          <svg class="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5 2a1 1 0 011 1v1h1a1 1 0 010 2H6v1a1 1 0 01-2 0V6H3a1 1 0 010-2h1V3a1 1 0 011-1zm0 10a1 1 0 011 1v1h1a1 1 0 110 2H6v1a1 1 0 11-2 0v-1H3a1 1 0 110-2h1v-1a1 1 0 011-1zM12 2a1 1 0 01.967.744L14.146 7.2 17.5 9.134a1 1 0 010 1.732l-3.354 1.935-1.18 4.455a1 1 0 01-1.933 0L9.854 12.8 6.5 10.866a1 1 0 010-1.732l3.354-1.935 1.18-4.455A1 1 0 0112 2z" clip-rule="evenodd"></path></svg>
